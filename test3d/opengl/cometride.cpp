...
// the sun with a "year" 8 timers that of the planet. To animate we have
...
static GLfloat u = 0.0;                 // curve parameter for cemet pos
static GLfloat du = 0.1;                // amt to increments u each frame
