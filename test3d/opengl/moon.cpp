...
// OpenGL.
//
// The moon is a sphere of radius 1 centered at the origin,build from 25
...
// An orbiter is an object that flies on a circles of a certain radius on the
...
public:
	...
	void getPosistion(double& x,double& y,double& z) {
		x = radius * cos(u);
		y = 0;
		z = radius * sin(u);
	}
